const achievements = [
    {
        req: [
            ...
            _=> data.ord.isPsi,
            _=> data.ord.isPsi && ((data.ord.ordinal >= BHO_VALUE && data.ord.base === 3) || (data.ord.ordinal >= 2**288 && data.ord.base === 2)),
        ],
        name: [
            "The First Ordinal",
            "Many More Ordinals",
    ...
    },
    {
        req: [
            ...
            _=> allGte(data.chal.completions, 3) && data.chal.totalCompletions >= 24,
        ],
        name: [
            "Way Too Easy",
            "Still Too Easy",
