  ...
  tabFormat: {
    ...
    "Overflow":{
      ...
      content: [
        ...
        ["display-text",function(){
          if (!hasUpgrade("c",14))return
          return "You have "+format(player.h.overcharge)+" overcharge,<br>strengthening all booster power effects by "+format(layers.h.overchargeEffect(), 4)+"x"+(hasUpgrade("c",32)?",<br>raising <b>Incrementy</b>'s gain to the ^"+format(layers.h.overchargeEffect(), 4):"")
        }],
      ]
    },
    "Charge":{
...
addLayer("gwa", {
    ...
    milestones: {
        0: {
            ...
            effectDescription: "beat the game",
...
function getIncrementyGain(){
  ...
  if (hasUpgrade("c",32))gain=gain.pow(layers.h.overchargeEffect())
  return gain
}
function getPsiGain(){
  let gain = new Decimal(1)
