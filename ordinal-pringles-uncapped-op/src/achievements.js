const achievements = [
    {
        req: [
            ...
            _=> data.ord.ordinal.gte(Decimal.tetrate(data.ord.base, 3)) || data.ord.isPsi,
        ],
        name: [
            "The First Ordinal",
            "Many More Ordinals",
    ...
    {
        req: [
            _=> data.factors[0].gt(0),
            _=> data.factors[1].gt(0),
            _=> data.factors[2].gt(0),
            _=> data.factors[3].gt(0),
            _=> data.factors[4].gt(0),
            _=> data.factors[5].gt(0),
            _=> data.factors[6].gt(0),
        ],
        name: [
            "Speed",
