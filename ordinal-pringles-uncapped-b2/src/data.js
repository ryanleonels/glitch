...
const VERSION = "0.0.2b2"
const VERSION_NAME = "True Base 2 Edition"
const VERSION_DATE = "June 6th, 2023"
...
function save(){
    try{
        ...
        window.localStorage.setItem('ordinalPRINGLESsave2b', JSON.stringify(data))
    }
    catch (e) {
...
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('ordinalPRINGLESsave2b'))
...
function deleteSave(){
    window.localStorage.removeItem('ordinalPRINGLESsave2b')
    location.reload()
}
