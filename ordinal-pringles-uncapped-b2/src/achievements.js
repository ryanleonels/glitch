const achievements = [
    {
        req: [
            ...
            _=> calculateHardy().gte(1.79e308) || data.ord.isPsi,
            _=> data.ord.ordinal >= data.ord.base**data.ord.base || data.ord.isPsi ,
            _=> data.ord.isPsi,
            _=> data.ord.isPsi && ((data.ord.ordinal >= BHO_VALUE && data.ord.base === 3) || (data.ord.ordinal >= 2**155 && data.ord.base === 2)),
        ],
        name: [
            "The First Ordinal",
            "Many More Ordinals",
        ...
        popup: [
            ...
            "Reach ω^ω",
            "Reach Ψ(Ω)",
            "Reach Ψ(Ω₂) in base 3 or Ψ(Ω_(I+1)) in base 2",
        ]
    },
    {
        req: [
    ...
    },
    {
        req: [
            ...
            _=> allEqual(data.chal.completions, 3) && data.chal.totalCompletions >= 24,
        ],
        name: [
            "Way Too Easy",
            "Still Too Easy",
    ...
    },
    {
        req: [
            ...
            _=> data.hierarchies.hasUpgrade[1],
        ],
        name: [
            "Ordinals 2.0",
            "Ordinals 3.0",
