  ...
  challenges:{
    ...
    11: {
        ...
        challengeDescription(){
          if (hasSL(16)) return "You are trapped in C7 and the base is 10. Square root incrementy and psi ordinal gain, and the first 2 alephs are weaker."
          return "All Booster challenges at once and the base is 10. Square root incrementy and psi ordinal gain, and the first 2 alephs are weaker."},
    ...
    "Singularity": {
      ...
      content: [
        ...
        ["display-text", function(){
          ...
          return "SL16: Light mode no longer puts you in C1-6 or C8"
        }, function(){
