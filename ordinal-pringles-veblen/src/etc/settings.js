...
function toggleOrdVeblen(){
    data.ord.veblen = !data.ord.veblen
    DOM(`changeOrdVeblen`).children[1].innerHTML = data.ord.veblen ? `[ON]` : `[OFF]`
    DOM(`changeOrdVeblen`).children[1].style.color = data.ord.veblen ? '#2da000' : '#ce0b0b'
}
