...
function tick(diff){
    ...
    boostLimit = (data.ord.base === 2) ? (data.trueUncapped ? Infinity : 99) : 33
}
...
window.onload = function () {
    ...
    makeExcessOrdMarks()
    makeExcessOrdMarks2() // sequence changed to enable loading of excess ordMarks & ordMarks2 in HTML
