...
class SingularityFunction {
  ...
  specialReq() {
    ...
    if (this.id==92&&EN(getSingLevel()).minus(game.spentENFunctions).lt(2500)) return false
    if (this.id==101&&EN(getSingLevel()).minus(game.spentENFunctions).lt(20)) return false
    if (this.id==111&&EN(getSingLevel()).minus(game.spentENFunctions).lt(250)) return false
    if (this.id==121&&!game.ivups.includes(4)) return false
    if (this.id==141&&getfractalshift()<=4.5) return false
...
let singfunctions = [
  ...
  SF(EN(1250), [81], 91, [0,0]),
  SF(EN(2000), [81], 92, [0,0]),
  SF(EN(1e6), [81], 93, [0,0]),
  SF(EN(0), [91], 101, [0,0]),
  SF(EN(4000), [92], 102, [0,0]),
