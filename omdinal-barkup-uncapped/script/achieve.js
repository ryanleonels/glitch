const achieveData = [
  ...
  },
  {
    ...
    achieve: [
      ...
      () => game.factorBoosts>=69,
      () => game.factorBoosts>=100,
      () => game.factorBoosts>=200,
      () => game.factorBoosts>=300,
      () => game.factorBoosts>=400,
      () => game.factorBoosts>=500,
    ],
    name: [
      "Boost!",
      "Booster Pack",
    ...
    tooltip: [
      ...
      "Perform 69 Factor Boosts",
      "Perform 100 Factor Boosts",
      "Perform 200 Factor Boosts",
      "Perform 300 Factor Boosts",
      "Perform 400 Factor Boosts",
      "Perform 500 Factor Boosts",
    ]
  },
  {
  ...
  },
  {
    ...
    tooltip: [
      ...
      "Complete Omega Challenge 6 1.21 times",
    ]
  },
  {
    ...
    achieve: [
      ...
      () => game.incrementy.gte(EN(10).arrow(10)(10)),
      () => game.incrementy.gte(EN(10).arrow(100)(10)),
      () => game.incrementy.gte(EN(10).arrow(Number.MAX_VALUE)(10)),
      () => game.incrementy.gte(EN(10).arrow(EN(10).arrow(10)(10))(10)),
    ],
    name: [
      "Welcome to the E",
      "E for exponential",
