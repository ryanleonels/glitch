...
function load() {
  const loadgame = JSON.parse(localStorage.getItem("ordinalMarkupSaveUnfunmodeX1000"));
...
function save() {
  if (AF === 0) localStorage.setItem("ordinalMarkupSaveUnfunmodeX1000", JSON.stringify(game));
}
