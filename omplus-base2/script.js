...
let game
let factorShiftCosts=[200, 1000, 10000, 350000, 10**12, 10**21, 10**100, 1.095*10**272, V(27)]
...
function reset() {
  ...
  autoOn: {max: 1, inf: 1},
  challenge: 0,
  challengeCompletion: [3,3,3,3,3,3,3],
  incrementy: 0,
  manifolds: 0,
...
function render() {
  ...
  document.getElementById("factorShift").innerHTML = "Factor Shift (" + game.factorShifts + "): Requires " + ((game.challenge==5||game.challenge==7) && game.factorShifts >= 2?"Infinity":(game.factorShifts==7?(game.boostUnlock&&false?"Infinity":"Graham's number (g<sub>ψ(Ω<sup>Ω</sup>ω)</sub> (10))"):beautify(factorShiftCosts[game.factorShifts]))) +" OP"
