function mainLoop() {
    ...
    if(data.collapse.hasSluggish[0] && calculateHardy().gt(10240) && !data.ord.isPsi && data.markup.powers < 4e256) data.markup.powers += (totalOPGain()/100)*uDiff
...
window.onload = function () {
    ...
    if(data.collapse.times > 0) { makeExcessOrdMarks(); makeExcessOrdMarks2(); }
}
