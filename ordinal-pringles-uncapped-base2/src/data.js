...
const VERSION = "0.0.2b1"
const VERSION_NAME = "Base 2 Edition feat. Bulk Boosting"
const VERSION_DATE = "June 4th, 2023"
...
function save(){
    try{
        ...
        window.localStorage.setItem('ordinalPRINGLESsave2', JSON.stringify(data))
    }
    catch (e) {
...
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('ordinalPRINGLESsave2'))
...
function deleteSave(){
    window.localStorage.removeItem('ordinalPRINGLESsave2')
    location.reload()
}
