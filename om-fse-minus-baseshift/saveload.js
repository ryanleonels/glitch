...
function load() {
  let loadgame = JSON.parse(localStorage.getItem("om-fse-save-baseshift")); //ordinalMarkupSave
...
function save() {
  if (AF === 0) localStorage.setItem("om-fse-save-baseshift", JSON.stringify(game));
}
