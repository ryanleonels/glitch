...
function load() {
  let loadgame = JSON.parse(localStorage.getItem("om-fse-save-baseless")); //ordinalMarkupSave
...
function save() {
  if (AF === 0) localStorage.setItem("om-fse-save-baseless", JSON.stringify(game));
}
