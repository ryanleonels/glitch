...
function enterChallenge(c) {
  if (game.challenge === 0 && (game.challengeCompletion[c - 1] < 2.5||game.upgrades.includes(17)) && game.chal8 === 0 && game.chal9 === 0) {
	let conf;
