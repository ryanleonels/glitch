function mainLoop() {
    ...
    if(data.ord.isPsi && data.boost.unlocks[1] && data.incrementy.rebuyableAmt[6] > 0) data.incrementy.amt = data.incrementy.amt.mul(Decimal.pow(10, data.incrementy.rebuyableAmt[6] * (uDiff * 20)))
