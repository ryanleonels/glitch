...
const IS_BETA = false
const SAVE_PATH = () => IS_BETA ? "ordinalPRINGLESBETAsaveFractal" : "ordinalPRINGLESsaveFractal"
...
function getDefaultObject() {
    return {
        ...
        incrementy: {amt:D(0), hasIUP:Array(13).fill(false), rebuyableAmt: Array(7).fill(0), charge:0, totalCharge:0},
