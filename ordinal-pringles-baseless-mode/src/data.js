...
//saving and loading
function save(){
    try{ window.localStorage.setItem('ordinalPRINGLESsave0', JSON.stringify(data)) }
    catch (e) {
...
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('ordinalPRINGLESsave0'))
...
function deleteSave(){
    window.localStorage.removeItem('ordinalPRINGLESsave0')
    location.reload()
}
