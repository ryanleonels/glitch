...
function load() {
  ...
  const key = testing ? "ordinalMarkupPublicTestingSaveFixedX1000" : "ordinalMarkupSaveFixedX1000"
...
function save() {
  if (AF === 0) {
    localStorage.setItem((inPublicTesting()?"ordinalMarkupPublicTestingSaveFixedX1000":"ordinalMarkupSaveFixedX1000"), JSON.stringify(game))
  };
}
// hi
