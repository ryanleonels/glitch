...
function getDiagSlowdown() {
  ...
  //let k1=EN(game.fupgrades.includes(14)&&game.ord.lt(EN.tetr(game.base, 3))?game.factorials.add(1e10).log10().div(10):1)
  //let k1=EN(game.fupgrades.includes(10)?omegaFactorMult.log10().add(1).sqrt():1)
  return k.times(game.fupgrades.includes(7)?1.2:1)//.times(k1)
}
