...
function load() {
  let loadgame = JSON.parse(localStorage.getItem("om-fse-save-baseselect")); //ordinalMarkupSave
...
function save() {
  if (AF === 0) localStorage.setItem("om-fse-save-baseselect", JSON.stringify(game));
}
