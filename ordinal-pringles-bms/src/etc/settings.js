const SETTINGS_DESCS = [
    ...
    "Charge Sacrifice Confirmation", "Use Veblen Notation", "Hardy Value Display for Ordinals >= Ψ(Ω)",
    "<img src='https://cdn.discordapp.com/emojis/853002327362895882.webp?size=24'> Display", "Use BMS Notation", "x1000 Gameplay Speed"
]
const settingsDefaults = [true, true, true, true, true, true, true, true, true, true, true, true, false, false, false, false, false]
